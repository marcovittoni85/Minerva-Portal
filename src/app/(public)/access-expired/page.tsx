...
export default function AccessExpired() {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-8 text-center">
      ...
      <h1 className="text-[#F5A623] text-2xl tracking-[0.4em] uppercase font-light mb-6">Periodo di Prova Terminato</h1>
      ...
      <div className="space-y-4">
        ...
        <a href="/login" className="block text-slate-400 text-[10px] uppercase font-bold tracking-widest hover:text-[#F5A623]">Torna al Login</a>
      </div>
    </div>
  );
}