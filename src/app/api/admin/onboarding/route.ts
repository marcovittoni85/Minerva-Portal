    ...
    await resend.emails.send({
      ...
      html: `
        <div style="background-color: #ffffff; padding: 45px; font-family: sans-serif; color: #1e293b; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0;">
          <h1 style="color: #F5A623; text-align: center; letter-spacing: 5px; font-weight: 300; text-transform: uppercase;">Minerva Partners</h1>
          ...
          <div style="background-color: #f8fafc; padding: 25px; border-radius: 12px; margin: 30px 0; border: 1px solid #f1f5f9;">
            <p style="margin: 0; font-size: 11px; text-transform: uppercase; color: #F5A623; font-weight: 800; letter-spacing: 2px; margin-bottom: 10px;">Le tue credenziali riservate</p>
          ...
          <div style="text-align: center; margin: 45px 0;">
            <a href="https://www.minervapartners.it/login" style="background-color: #0f172a; color: #F5A623; padding: 18px 40px; text-decoration: none; font-size: 12px; font-weight: bold; text-transform: uppercase; letter-spacing: 3px; border-radius: 8px; display: inline-block;">Accedi al Marketplace</a>
          </div>
