  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute top-[-20%] left-[-20%] w-[60%] h-[60%] bg-[#F5A623] blur-[150px] rounded-full opacity-5"
      />
      <motion.div 
        animate={{ opacity: [0.02, 0.05, 0.02], scale: [1, 1.2, 1] }}
        transition={{ duration: 12, repeat: Infinity, ease: "easeInOut", delay: 1 }}
        className="absolute bottom-[-20%] right-[-20%] w-[70%] h-[70%] bg-[#F5A623] blur-[180px] rounded-full opacity-5"
      />
      ...
      <motion.div
        ...
        style={{
            ...
            backgroundImage: `radial-gradient(circle at center, transparent 30%, #001220 100%), repeating-linear-gradient(45deg, #F5A623 0px, #F5A623 1px, transparent 1px, transparent 50px), repeating-linear-gradient(-45deg, #F5A623 0px, #F5A623 1px, transparent 1px, transparent 50px)`
        }}
      >
      </motion.div>
